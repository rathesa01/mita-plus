...
import { Geist, Geist_Mono, Noto_Sans_Thai, Nunito, Inter } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="th" className={`${geistSans.variable} ${geistMono.variable} ${notoSansThai.variable} ${nunito.variable} ${inter.variable} h-full antialiased dark`}>
